...
@implementation BBanAddressPerson
...
- (instancetype)initWithCNContact:(CNContact *)contact
{
    ...
    if (self)
    {
        self.contactType = contact.contactType == CNContactTypePerson ? BBanContactTypePerson : BBanContactTypeOrigination;
        ...
        if ([contact isKeyAvailable:CNContactPhoneNumbersKey])
        {
            ...
            {
                BBanPhone *phoneModel = [[BBanPhone alloc] initWithLabeledValue:labeledValue];
        ...
        if ([contact isKeyAvailable:CNContactEmailAddressesKey])
        {
            ...
            {
                BBanEmail *emailModel = [[BBanEmail alloc] initWithLabeledValue:labeledValue];
        ...
        if ([contact isKeyAvailable:CNContactPostalAddressesKey])
        {
            ...
            {
                BBanAddress *addressModel = [[BBanAddress alloc] initWithLabeledValue:labeledValue];
        ...
        // 生日
        BBanBirthday *birthday = [[BBanBirthday alloc] initWithCNContact:contact];
        ...
        if ([contact isKeyAvailable:CNContactInstantMessageAddressesKey])
        {
            ...
            {
                BBanMessage *messageModel = [[BBanMessage alloc] initWithLabeledValue:labeledValue];
        ...
        if ([contact isKeyAvailable:CNContactSocialProfilesKey])
        {
            ...
            {
                BBanSocialProfile *socialModel = [[BBanSocialProfile alloc] initWithLabeledValue:labeledValue];
        ...
        if ([contact isKeyAvailable:CNContactRelationsKey])
        {
            ...
            {
                BBanContactRelation *relationModel = [[BBanContactRelation alloc] initWithLabeledValue:labeledValue];
        ...
        if ([contact isKeyAvailable:CNContactUrlAddressesKey])
        {
            ...
            {
                BBanUrlAddress *urlModel = [[BBanUrlAddress alloc] initWithLabeledValue:labeledValue];
...
- (instancetype)initWithRecord:(ABRecordRef)record
{
    ...
    if (self)
    {
        ...
        self.contactType = type == kABPersonKindPerson ? BBanContactTypePerson : BBanContactTypeOrigination;
        CFRelease(type);
        ...
        {
            BBanPhone *phoneModel = [[BBanPhone alloc] initWithMultiValue:multiPhones index:i];
            [phones addObject:phoneModel];
        }
        ...
        {
            BBanEmail *emailModel = [[BBanEmail alloc] initWithMultiValue:multiEmails index:i];
            [emails addObject:emailModel];
        }
        ...
        {
            BBanAddress *addressModel = [[BBanAddress alloc] initWithMultiValue:multiAddresses index:i];
            [addresses addObject:addressModel];
        }
        ...
        // 生日
        BBanBirthday *birthday = [[BBanBirthday alloc] initWithRecord:record];
        self.birthday = birthday;
        ...
        {
            BBanMessage *messageModel = [[BBanMessage alloc] initWithMultiValue:multiMessages index:i];
            [messages addObject:messageModel];
        }
        ...
        {
            BBanSocialProfile *socialModel = [[BBanSocialProfile alloc] initWithMultiValue:multiSocials index:i];
            [socials addObject:socialModel];
        }
        ...
        {
            BBanContactRelation *relationModel = [[BBanContactRelation alloc] initWithMultiValue:multiRelations index:i];
            [relations addObject:relationModel];
        }
        ...
        {
            BBanUrlAddress *urlModel = [[BBanUrlAddress alloc] initWithMultiValue:multiURLs index:i];
...
- (instancetype)initWithMultiValue:(ABMultiValueRef)multiValue index:(CFIndex)index
{
    ...
    if (self)
    {
        CFStringRef label = ABMultiValueCopyLabelAtIndex(multiValue, index);        // 电话标签
        self.label = CFBridgingRelease(ABAddressBookCopyLocalizedLabel(label));  // 本地化电话标签
        NSString *phoneNumber = CFBridgingRelease(ABMultiValueCopyValueAtIndex(multiValue, index));  // 电话号码
        self.phone = [self _filterSpecialString:phoneNumber];
        CFRelease(label);
    }
    return self;
...
@implementation BBanSocialProfile
...
@implementation BBanContactRelation
...
@implementation BBanSectionPerson
